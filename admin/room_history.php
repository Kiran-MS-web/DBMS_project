...
<div class="form-container" style="max-width: 600px; width: 95%;">
    <div class="glass-card mb-4">
        <h2 class="title-main text-center">Global Booking Details</h2>
        <p class="subtitle text-center mb-4">Detailed view of a guest's past stay.</p>
            ...
            if ($row = $result->fetch_assoc()) {
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 1.1rem;">
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #cbd5e1;">
                            <th style="padding: 1rem; text-align: left;">Guest Phone:</th>
                            <td style="padding: 1rem; text-align: right;"><?php echo htmlspecialchars($row['phone']); ?></td>
                        </tr>
                        <tr style="border-bottom: 1px solid #cbd5e1;">
                ...
                echo "<p class='text-center' style='color: red;'>Booking not found.</p>";
            }
            $stmt->close();
        } else {
        ...
        <div class="text-center mt-4">
            <a href="booking_history.php" class="btn btn-primary" style="display: inline-block;">Back to History</a>
        </div>
    </div>
</div>
