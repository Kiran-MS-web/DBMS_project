...
<div class="form-container">
    <div class="glass-card">
        ...
        <div class="form-row mt-4">
            <a href="admin_signup.php" class="btn btn-secondary" style="flex: 1; margin-right: 0.5rem;">Sign Up</a>
            <a href="admin_forgot_pwd.php" class="btn btn-secondary" style="flex: 1; margin-left: 0.5rem;">Forgot Password</a>
        </div>
    </div>
</div>
