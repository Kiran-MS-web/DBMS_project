...
<div class="form-container" style="max-width: 900px; width: 95%;">
    <div class="glass-card mb-4">
        <h2 class="title-main text-center">Remove Rooms</h2>
        <p class="subtitle text-center">Decrease the inventory of available rooms.</p>
    ...
    <div class="glass-card">
        <h3 class="text-center mb-4" style="color: var(--secondary-color);">Remove Room Inventory</h3>
        <form action="admin_room_removed.php" method="post" class="form-row" style="align-items: flex-end;">
            ...
            <div style="flex: 1;">
                <button type="submit" class="btn btn-secondary" style="width: 100%; border-color: red; color: red;">Remove Rooms</button>
            </div>
        </form>
    </div>
</div>
