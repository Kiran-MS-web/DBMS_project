...
<div class="form-container" style="max-width: 900px; width: 95%;">
    <div class="glass-card mb-4">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 2rem;">
            ...
            <tbody>
                ...
                $stmt = $conn->prepare("SELECT book_id, name, room_type, checkin, checkout, price FROM booked_hist WHERE phone = ? AND idproof = ?");
    ...
    <div class="glass-card">
        <h3 class="text-center mb-4" style="color: var(--secondary-color);">View Booking Details</h3>
        <form action="user_room_history.php" method="post" class="form-row" style="align-items: flex-end;">
